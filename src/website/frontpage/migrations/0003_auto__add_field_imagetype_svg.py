...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ImageType.svg'
        db.add_column(u'frontpage_imagetype', 'svg',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ImageType.svg'
        db.delete_column(u'frontpage_imagetype', 'svg')
    ...
    models = {
        ...
        u'frontpage.imagetype': {
            ...
            'is_public': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'db_index': 'True'}),
            'sort_value': ('django.db.models.fields.IntegerField', [], {'default': '10', 'db_index': 'True'}),
            'svg': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': "'250'", 'null': 'True', 'blank': 'True'})
        },
        'mediastore.media': {
